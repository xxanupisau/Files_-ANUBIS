...
if Manager(msg) then
if DevSIRI:get(ANUBIS.."SIRI:Lock:ProNames"..msg.chat_id_) then
local Txt = text:match("^وضع توحيد (.*)$") or text:match("^ضع توحيد (.*)$")
send(msg.chat_id_, msg.id_,'⌯︙تم تعيين ↫ '..Txt..' كتوحيد للمجموعه')
DevSIRI:set(ANUBIS.."SIRI:ProNames:Txt"..msg.chat_id_,Txt)
else
...
DevSIRI:set(ANUBIS.."SIRI:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌯︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevSIRI:get(ANUBIS.."SIRI:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevSIRI:get(ANUBIS.."SIRI:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevSIRI:get(ANUBIS.."SIRI:ProNames:Num"..msg.chat_id_) or 5
...
if DevSIRI:get(ANUBIS.."SIRI:Lock:ProNames"..msg.chat_id_) and DevSIRI:get(ANUBIS.."SIRI:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevSIRI:get(ANUBIS.."SIRI:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevSIRI:srem(ANUBIS..'SIRI:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevSIRI:get(ANUBIS.."SIRI:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevSIRI:get(ANUBIS.."SIRI:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(UserNum) == tonumber(ProNamesTxt) or tonumber(UserNum) > tonumber(ProNamesTxt)) then 
DevSIRI:sadd(ANUBIS..'SIRI:Muted:'..msg.chat_id_, msg.sender_user_id_)
DevSIRI:del(ANUBIS.."SIRI:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
DevSIRI:incrby(ANUBIS.."SIRI:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عذرا عزيزي ↫ ["..result.first_name_.."](https://t.me/"..(result.username_ or "Dev_Prox")..")\n⌯︙عليك وضع التوحيد ↫ `"..DevSIRI:get(ANUBIS.."SIRI:ProNames:Txt"..msg.chat_id_).."` بجانب اسمك\n⌯︙عدد المحاولات المتبقيه ↫ "..(tonumber(ProNamesTxt) - tonumber(UserNum)).."")
end
end
end
end,nil)
...
DevSIRI:set(ANUBIS.."SIRI:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌯︙تم تعطيل توحيد المجموعه')
DevSIRI:del(ANUBIS.."SIRI:Lock:ProNames"..msg.chat_id_)
end
end
